...
const Herobooking = () => {
    return (
        <section className="h-[70vh] bg-herobooking bg-no-repeat bg-cover bg-center relative">
      {/* overlay */}
      <div className="absolute inset-0 bg-gradient-to-l from-black/0 via-black/50 to-black/70 z-10">
        <div className="container mx-auto h-full flex items-center">
          <div className="z-20 text-center xl:text-left mx-auto xl:mx-0 flex flex-col items-center xl:items-start max-w-[608px]">
            <motion.h1
              ...
              className="h1 mb-4"
            >
              <span className="text-accent">Book Your </span>
              <span className="text-white"> Game Instantly</span>
            </motion.h1>
            <motion.p
